...
# print('Coefficient of determination', r2_score(y,y_prediction))


# plt.plot([2020],model.predict([[2020]]),"o",color = "green")
# plt.plot([2050],model.predict([[2050]]),"o",color = "orange")
